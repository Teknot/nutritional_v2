...
const AddBiomakerListCard = ({childrenItem}) => {
  return (
    <View style={styles.vertical_list_view} key={childrenItem.id}>
              <View><Text style={styles.children_item_name}>{childrenItem.name}</Text></View>
              ...
              <TouchableOpacity style={styles.children_item_add_button}
              onPress={()=>{console.warn("add" , childrenItem.id)}}
              >
